...
| CI-FR-011 | CI-TEST-011 | Integration/resource/timeout | Forced failure; 4-KiB diagnostic, 1,000-finding, 8-MiB report, 32-MiB log, 64-MiB bundle, and 120-minute job exact/over boundaries; UTF-8 split, owned-process cleanup, and secret fixtures. | Exact-bound artifacts pass structurally; every over-limit follows its reject/truncate rule and cannot yield blocking pass; a synthetic clock tick beyond 120 minutes terminates the group and is non-pass; head/tail/count/digest exact; zero secret. | `failure-evidence-report.json`, `ci-evidence-limit-matrix.json`. |
