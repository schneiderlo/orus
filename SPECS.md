...
| [02-DECISIONS](specs/02-DECISIONS.md) | Ready | Maps every discovery answer and significant binding architecture tradeoff to an ADR-style decision. | Discovery questions, assumptions, charter, and project seed. |
...
| `specs/11-governance-release.md` | Draft | MIT license packaging, outside-contribution closure, ADR/dependency admission, third-party notices, SBOM, release provenance, repository/agent policy, and rollback/compatibility claim rules. | `10`; Foundation D-002/D-009. |
